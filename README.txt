...
As it comes, this type of "blind" gamble is not possible in the blockchain (At least not this style). From the fact that every data on blockchain is public, it is imposible for me to hide data like 'pool' size or 'highest stake'. So I would not recommend using this contract as a true gambling platform.
